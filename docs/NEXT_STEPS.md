...
### 已完成（2026-09-21）：批次志愿数上限核对

逐省查了考试院 2026 年招生实施办法/志愿设置公告，把 `batches.ts` 从 **37 条未核对降到 6 条**（规则总数 184）。已 sync + Xcode Debug 编译通过。

核对中发现的原始错误（都已修正，说明为什么必须核官方文件）：

| 省 | 原来写的 | 官方实际 |
| --- | --- | --- |
| 河南 | 专科提前批 32 顺序 | 64 个「专业+院校」平行 |
| 河北 | 提前批 A/B/C 均 96 | A/C 段各 1 所学校顺序，B 段 96 专业+学校 |
| 福建 | 本科批 50、专科批 30 | 本科批 40、专科批 40 专业志愿 |
| 四川 | 提前批 B 段 45 | 30；国家/高校专项各 6 |
| 辽宁 | 提前批 B 段 60 院校专业组 | 60 个「专业+学校」 |
| 上海 | 专科批 20 | 8（2026 年由 10 调为 8） |
| 内蒙古 | 本科/专科批 60？ | 确认 60 且每志愿 12 专业；提前批 A 段 1 顺序、B 段 60 |
| 青海 | 提前批 20 院校专业组 | ①段 2 顺序；②~⑥段各 60 专业平行；⑦/⑩段 96 |
| 新疆 | 本科一/二批顺序志愿 18 | 平行志愿 18；提前批 4 个梯度、专项 6 |
| 天津 | 提前批 20 平行 | A 阶段 1 顺序、B 阶段 5 平行、民航招飞 2 |

结构变化较大的省已按「段」拆开：山西（A/B/C）、黑龙江（5 小批次 + 专科 A/B）、宁夏（A/B）、青海（①~⑩段）、广西（4 小类）、海南（提前部分/普通批/预科/专项）、吉林、陕西（按类别）。

**仅剩 6 条未核对**（网上查不到 2026 官方文件）：西藏全部 3 条（2026 是传统高考最后一年，考试院文件未公开志愿数）、吉林专科提前批、内蒙古专科提前批、新疆高职专科批。
